		...
		<section class="cabecera" >
			<img alt="imagen1" src="images/header2.png" width="100%" height="100%" style="margin-top: 30px;">
				...
				<section class="sec1" id="1">
					...
					<a class="btn linea-naranja" style="font-size:22px; margin-right: 400px; padding: 19px 10px;" href="{{url('/')}}/#votacion"><strong>IR A VOTACIONES</strong></a>
					</div>
				</section>
				...
				@foreach ($deportistas as $deportista)
					...
					<a class="listadoImagenes " style="background:url('{{ $deportista->ruta_img }}'); background-size: contain;" href="{{ url('/deportista') }}/{{ $deportista->id }}">
					<div class="transbox">
					<p style="padding-top:120px; font-size:40px; color:#fff;"><strong>{{ $deportista->nombres }}</strong> </p>
					<p style="font-size:40px;"><strong>{{ $deportista->apellidos }}</strong></p>
					</div>
					</a>
				@endforeach
				</div>
