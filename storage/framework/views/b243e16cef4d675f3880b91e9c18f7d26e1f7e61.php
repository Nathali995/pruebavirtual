    ...
    <body>
        <div class="full-height">
            ...
            <div class="content">
                <div class="">
                    <div class="col-md-9 ">
                    <img class="izquierda" alt="foto" src="../<?php echo e($deportista->ruta_img); ?>" width="95%" height="445px">
                    ...
                    <p style="font-family: Montserrat-ExtraBold; font-size:50px; margin-top:40px;"><strong><?php echo e($deportista->nombres); ?></strong> <strong><?php echo e($deportista->apellidos); ?></strong></p>
					...
					<a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(url('/')); ?>" target="_blank"><img src="https://lh3.googleusercontent.com/-H8xMuAxM-bE/UefWwJr2vwI/AAAAAAAAEdY/N5I41q19KMk/s32-no/facebook.png"></a>
